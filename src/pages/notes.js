...
const tagStyle = { fontSize: 12, color: "var(--subtle)", fontFamily: "var(--mono)", marginBottom: "0.4rem" }
const titleStyle = { fontSize: 17, color: "var(--text)", lineHeight: 1.45 }
const dateStyle = { fontSize: 13, color: "var(--subtle)", marginTop: "0.6rem", fontFamily: "var(--mono)" }
